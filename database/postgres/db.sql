GRANT ALL PRIVILEGES ON DATABASE "WSO2AM_DB" TO wso2carbon;
    \c "WSO2AM_DB"
        ...
        CREATE TABLE IF NOT EXISTS APK_USER (
        ...
        FOREIGN KEY(USER_UUID) REFERENCES APK_USER(UUID) ON UPDATE CASCADE ON DELETE RESTRICT,
        PRIMARY KEY(UUID),
        ...
        FOREIGN KEY(API_UUID) REFERENCES API(UUID) ON
        UPDATE CASCADE ON DELETE CASCADE,
        FOREIGN KEY(USER_UUID) REFERENCES APK_USER(UUID) ON UPDATE CASCADE ON DELETE CASCADE,
        ...
        USER_UUID VARCHAR(100),
        FOREIGN KEY(API_UUID) REFERENCES API(UUID) ON UPDATE CASCADE ON DELETE CASCADE,
        FOREIGN KEY(USER_UUID) REFERENCES APK_USER(UUID) ON
        ...
        INSERT INTO APK_USER(uuid, IDP_USER_NAME) VALUES ( 'apkuser', 'apkuser');
