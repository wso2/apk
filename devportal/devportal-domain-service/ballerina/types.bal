...
public type ApplicationTokenGenerateRequest record {
    ...
    string revokeToken?;
    "CLIENT_CREDENTIALS"|"TOKEN_EXCHANGE" grantType?;
    # Scopes to be assigned to the access token
    string[] scopes?;
...
public type KeyManagerInfo record {
    ...
    "EXCHANGED"|"DIRECT"|"BOTH" tokenType = "DIRECT";
};
...
public type ThrottlingPolicy record {
    string name;
    string description?;
    "application"|"subscription" policyLevel?;
...
public type APIKey record {
    # API Key
    string apikey?;
    int:Signed32 validityTime?;
};

public type DocumentSearchResult record {
    *SearchResult;
    "HOWTO"|"SAMPLES"|"PUBLIC_FORUM"|"SUPPORT_FORUM"|"API_MESSAGE_FORMAT"|"SWAGGER_DOC"|"OTHER" docType?;
    string summary?;
    "INLINE"|"URL"|"FILE"|"MARKDOWN" sourceType?;
    string sourceUrl?;
    string otherTypeName?;
...
public type MonetizationInfo record {
    "fixedPrice"|"dynamicRate" billingType?;
    string billingCycle?;
    string fixedPrice?;
