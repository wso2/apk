...
import org.wso2.apk.apimgt.devportal.mappings.AdditionalSubscriptionInfoMappingUtil;
import org.wso2.apk.apimgt.devportal.mappings.SubscriptionMappingUtil;
...
import org.wso2.apk.apimgt.devportal.dto.APIMonetizationUsageDTO;
import org.wso2.apk.apimgt.devportal.dto.AdditionalSubscriptionInfoListDTO;
import org.wso2.apk.apimgt.devportal.dto.SubscriptionDTO;
import org.wso2.apk.apimgt.devportal.dto.SubscriptionListDTO;
...
//                    subscriptionId, RestApiCommonUtil.getLoggedInUserProvider());
            Map<String, String> billingEngineUsageData = Collections.emptyMap();
            if (!billingEngineUsageData.isEmpty()) {
