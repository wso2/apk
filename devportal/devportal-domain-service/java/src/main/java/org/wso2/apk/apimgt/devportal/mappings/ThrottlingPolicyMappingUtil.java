...
import org.wso2.apk.apimgt.devportal.dto.ThrottlingPolicyListDTO;
import org.wso2.apk.apimgt.devportal.dto.ThrottlingPolicyPermissionInfoDTO;
...
import org.wso2.apk.apimgt.devportal.dto.MonetizationInfoDTO;
...
public class ThrottlingPolicyMappingUtil {
    ...
    public static ThrottlingPolicyDTO fromTierToDTO(Tier throttlingPolicy, String tierLevel) {
        ...
        //Todo APK
        if (!monetizationAttributeMap.isEmpty()) {
