...
import org.wso2.apk.apimgt.devportal.dto.ApplicationAttributeDTO;
import org.wso2.apk.apimgt.devportal.dto.ApplicationAttributeListDTO;
...
public class ApplicationMappingUtil {
    ...
    public static ApplicationDTO fromApplicationtoDTO(Application application) throws APIManagementException {
        ...
        if (StringUtils.isNotEmpty(application.getTokenType()) && !APIConstants.DEFAULT_TOKEN_TYPE.equals(
    ...
    public static void setPaginationParamsWithSortParams(ApplicationListDTO applicationListDTO, String groupId,
            int limit, int offset, int size, String sortOrder, String sortBy) {
        ...
        if (paginatedParams.get(RestApiConstants.PAGINATION_PREVIOUS_OFFSET) != null) {
            paginatedPrevious = RestApiCommonUtil.getApplicationPaginatedURLWithSortParams(
                    paginatedParams.get(RestApiConstants.PAGINATION_PREVIOUS_OFFSET),
                    paginatedParams.get(RestApiConstants.PAGINATION_PREVIOUS_LIMIT), groupId, sortOrder, sortBy);
        }

        if (paginatedParams.get(RestApiConstants.PAGINATION_NEXT_OFFSET) != null) {
            paginatedNext = RestApiCommonUtil.getApplicationPaginatedURLWithSortParams(
