...
import org.wso2.apk.apimgt.devportal.mappings.CommentMappingUtil;
...
import org.wso2.apk.apimgt.devportal.dto.CommentDTO;
import org.wso2.apk.apimgt.devportal.dto.CommentListDTO;
import org.wso2.apk.apimgt.devportal.dto.DocumentDTO;
import org.wso2.apk.apimgt.devportal.dto.DocumentListDTO;
import org.wso2.apk.apimgt.devportal.dto.GraphQLQueryComplexityInfoDTO;
import org.wso2.apk.apimgt.devportal.dto.GraphQLSchemaTypeListDTO;
import org.wso2.apk.apimgt.devportal.dto.PaginationDTO;
import org.wso2.apk.apimgt.devportal.dto.PostRequestBodyDTO;
import org.wso2.apk.apimgt.devportal.dto.RatingDTO;
import org.wso2.apk.apimgt.devportal.dto.RatingListDTO;
import org.wso2.apk.apimgt.devportal.dto.ThrottlingPolicyDTO;
import org.wso2.apk.apimgt.devportal.dto.TopicListDTO;
import org.wso2.apk.apimgt.devportal.mappings.APIMappingUtil;
import org.wso2.apk.apimgt.devportal.mappings.AsyncAPIMappingUtil;
import org.wso2.apk.apimgt.devportal.mappings.DocumentationMappingUtil;
import org.wso2.apk.apimgt.devportal.mappings.GraphqlQueryAnalysisMappingUtil;
...
public class ApisCommonImpl {
    ...
    public static List<Tier> getSubscriptionPolicies(String apiId, String organization) throws APIManagementException {
        ...
        if (apiInfo != null && apiInfo.getTiers() != null) {
            List<String> apiTiersNameList = apiInfo.getTiers().stream().map(APITiersInnerDTO::getTierName)
