...
![Version: 1.1.0-m1](https://img.shields.io/badge/Version-1.1.0-m1--informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.16.0](https://img.shields.io/badge/AppVersion-1.16.0-informational?style=flat-square)
...
| wso2.apk.dp.configdeployer.deployment.image | string | `"wso2/apk-config-deployer-service:1.1.0-m1"` | Image |
...
| wso2.apk.dp.adapter.deployment.image | string | `"wso2/apk-adapter:1.1.0-m1"` | Image |
...
| wso2.apk.dp.commonController.deployment.image | string | `"wso2/apk-common-controller:1.1.0-m1"` | Image |
...
| wso2.apk.dp.ratelimiter.deployment.image | string | `"wso2/apk-ratelimiter:1.1.0-m1"` | Image |
...
| wso2.apk.dp.gatewayRuntime.deployment.router.image | string | `"wso2/apk-router:1.1.0-m1"` | Image |
...
| wso2.apk.dp.gatewayRuntime.deployment.enforcer.image | string | `"wso2/apk-enforcer:1.1.0-m1"` | Image |
...
| idp.idpds.deployment.image | string | `"wso2/apk-idp-domain-service:1.1.0-m1"` | Image |
...
| idp.idpui.deployment.image | string | `"wso2/apk-idp-ui:1.1.0-m1"` | Image |
