...
| wso2.apk.dp.configdeployer.deployment.image | string | `"wso2/apk-config-deployer-service:1.3.0"` | Image |
...
| wso2.apk.dp.adapter.deployment.image | string | `"wso2/apk-adapter:1.3.0"` | Image |
...
| wso2.apk.dp.commonController.deployment.image | string | `"wso2/apk-common-controller:1.3.0"` | Image |
...
| wso2.apk.dp.ratelimiter.deployment.image | string | `"wso2/apk-ratelimiter:1.3.0"` | Image |
...
| wso2.apk.dp.gatewayRuntime.deployment.router.image | string | `"wso2/apk-router:1.3.0"` | Image |
...
| wso2.apk.dp.gatewayRuntime.deployment.enforcer.image | string | `"wso2/apk-enforcer:1.3.0"` | Image |
