 ...
 */
public class ApplicationNameWhiteSpaceValidationException extends APIManagementException {

    public ApplicationNameWhiteSpaceValidationException(String msg) {
        super(msg);
    }
