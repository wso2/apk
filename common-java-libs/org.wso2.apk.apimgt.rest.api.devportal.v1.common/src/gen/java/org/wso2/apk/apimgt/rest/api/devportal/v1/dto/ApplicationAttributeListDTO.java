...
public class ApplicationAttributeListDTO   {
  ...
  private List<ApplicationAttributeDTO> _list = null;
  ...
  /**
   **/
  public ApplicationAttributeListDTO _list(List<ApplicationAttributeDTO> _list) {
    this._list = _list;
    return this;
  }
  ...
  public void setList(List<ApplicationAttributeDTO> _list) {
    this._list = _list;
  }

  public ApplicationAttributeListDTO addListItem(ApplicationAttributeDTO _listItem) {
    if (this._list == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(count, applicationAttributeList.count) &&
        Objects.equals(_list, applicationAttributeList._list);
  }
