...
public class APIDTO   {
  ...
  private List<APITiersInnerDTO> tiers = null;
  ...
  private List<APIEndpointURLsInnerDTO> endpointURLs = null;
   ...
   **/
  public APIDTO tiers(List<APITiersInnerDTO> tiers) {
    this.tiers = tiers;
    return this;
  }
  ...
  @JsonProperty("tiers")
  public List<APITiersInnerDTO> getTiers() {
    return tiers;
  }
  public void setTiers(List<APITiersInnerDTO> tiers) {
    this.tiers = tiers;
  }

  public APIDTO addTiersItem(APITiersInnerDTO tiersItem) {
    if (this.tiers == null) {
   ...
   **/
  public APIDTO additionalProperties(List<APIInfoAdditionalPropertiesInnerDTO> additionalProperties) {
  ...
  /**
   **/
  public APIDTO endpointURLs(List<APIEndpointURLsInnerDTO> endpointURLs) {
  ...
  public List<APIEndpointURLsInnerDTO> getEndpointURLs() {
    return endpointURLs;
  }
  public void setEndpointURLs(List<APIEndpointURLsInnerDTO> endpointURLs) {
    this.endpointURLs = endpointURLs;
  }

  public APIDTO addEndpointURLsItem(APIEndpointURLsInnerDTO endpointURLsItem) {
