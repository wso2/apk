...
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.MonetizationInfoDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.ThrottlingPolicyPermissionInfoDTO;
...
public enum PolicyLevelEnum {
    ...
    APPLICATION(String.valueOf("application")), SUBSCRIPTION(String.valueOf("subscription"));
...
public enum QuotaPolicyTypeEnum {
    ...
    REQUESTCOUNT(String.valueOf("REQUESTCOUNT")), BANDWIDTHVOLUME(String.valueOf("BANDWIDTHVOLUME"));
...
public enum TierPlanEnum {
    ...
    FREE(String.valueOf("FREE")), COMMERCIAL(String.valueOf("COMMERCIAL"));
