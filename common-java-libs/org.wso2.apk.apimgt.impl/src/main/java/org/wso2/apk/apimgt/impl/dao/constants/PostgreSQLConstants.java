...
public class PostgreSQLConstants {
        ...
        public static final String ADD_API_DEFINITION_SQL = "INSERT INTO API_ARTIFACT (ORGANIZATION, API_UUID" +
                ", API_DEFINITION, MEDIA_TYPE) VALUES (?,?,?,?)";

        public static final String GET_API_ARTIFACT_SQL = "SELECT ap.ARTIFACT, ar.API_DEFINITION, ar.MEDIA_TYPE FROM API ap," +
                " API_ARTIFACT ar WHERE ap.ORGANIZATION=ar.ORGANIZATION AND ap.API_UUID=ar.API_UUID AND ar.API_UUID=? AND ar.ORGANIZATION=?;";

        public static final String GET_DEVPORTAL_API_ARTIFACT_SQL = "SELECT ap.ARTIFACT, ar.API_DEFINITION, ar.MEDIA_TYPE FROM API ap," +
                " API_ARTIFACT ar WHERE ap.ORGANIZATION=ar.ORGANIZATION AND ap.API_UUID=ar.API_UUID AND ar.API_UUID=? AND ar.ORGANIZATION=? AND ap.ARTIFACT @> '{\"status\": \"PUBLISHED\"}';";

        public static final String GET_REVISION_API_ARTIFACT_SQL = "SELECT am.ARTIFACT, ar.API_DEFINITION, ar.MEDIA_TYPE FROM API_REVISION_METADATA am," +
                " API_ARTIFACT ar WHERE am.REVISION_UUID=ar.API_UUID AND am.REVISION_UUID=? AND ar.ORGANIZATION=?;";

        public static final String UPDATE_API_DEFINITION_SQL = "UPDATE API_ARTIFACT SET API_DEFINITION=?,MEDIA_TYPE=? WHERE ORGANIZATION=? AND API_UUID=?;";

        public static final String GET_API_DEFINITION_SQL = "SELECT API_DEFINITION,MEDIA_TYPE from API_ARTIFACT WHERE ORGANIZATION=? AND API_UUID=?;";
        public static final String SEARCH_ALL_APIS_SQL = "SELECT ARTIFACT, API_UUID FROM API WHERE ORGANIZATION=?;";
        ...
        public static final String ADD_SUBSCRIBER_SQL =
                " INSERT" +
                        "   INTO SUBSCRIBER (USER_ID, TENANT_ID, EMAIL_ADDRESS, DATE_SUBSCRIBED, CREATED_BY, CREATED_TIME, " +
                        "UPDATED_TIME) " +
                        " VALUES (?,?,?,?,?,?,?)";
        ...
        public static final String ADD_APPLICATION_ATTRIBUTES_SQL =
                " INSERT INTO APPLICATION_ATTRIBUTES (APPLICATION_ID, NAME, APP_ATTRIBUTE, TENANT_ID) VALUES (?,?,?,?)";
        ...
        public static final String ADD_API_SQL =
                " INSERT INTO API (API_PROVIDER,API_NAME,API_VERSION,CONTEXT,CONTEXT_TEMPLATE,CREATED_BY," +
                        "CREATED_TIME,API_TIER,API_TYPE,API_UUID,STATUS,ORGANIZATION,GATEWAY_VENDOR,VERSION_COMPARABLE,ARTIFACT)" +
                        " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,to_json(?::json))";
        ...
        public static final String SEARCH_API_CONTENT_SQL = "SELECT DISTINCT ARTIFACT,API_UUID FROM API JOIN JSONB_EACH_TEXT(ARTIFACT) e ON TRUE \n" +
                " WHERE ORGANIZATION=? AND e.value LIKE ?;";

        public static final String SEARCH_DOC_CONTENT_SQL = "SELECT ad.API_ID, adm.UUID, ar.API_NAME, ar.API_VERSION, ar.API_PROVIDER, ar.API_TYPE, adm.NAME, adm.TYPE, adm.SOURCE_TYPE, adm.VISIBILITY FROM API_RESOURCES ad, API ar, API_DOC_META_DATA adm WHERE ar.ORGANIZATION=? AND ad.RESOURCE_CONTENT @@ to_tsquery(?) AND ad.API_ID=ar.API_UUID AND ad.UUID=adm.RESOURCE_UUID;";

        public static final String UPDATE_API_ARTIFACT_SQL = "UPDATE API SET ARTIFACT[?] = TO_JSONB(?) WHERE ORGANIZATION=? AND API_UUID=?;";

        public static final String SEARCH_ALL_DEVPORTAL_SQL = "SELECT ARTIFACT, API_UUID FROM API WHERE ORGANIZATION=? AND ARTIFACT @> '{\"status\": \"PUBLISHED\"}';";

        public static final String SEARCH_ALL_CONTENT_DEVPORTAL_SQL = "SELECT DISTINCT ARTIFACT,API_UUID FROM API JOIN JSONB_EACH_TEXT(ARTIFACT) e ON TRUE \n" +
                " WHERE ORGANIZATION=? AND e.value LIKE ? AND ARTIFACT @> '{\"status\": \"PUBLISHED\"}';";

        public static final String SEARCH_ALL_DOC_DEVPORTAL_SQL = "SELECT ad.API_ID, adm.UUID, ar.API_NAME, ar.API_VERSION, ar.API_PROVIDER, ar.API_TYPE, adm.NAME, adm.TYPE, adm.SOURCE_TYPE, adm.VISIBILITY FROM API_RESOURCES ad, API ar, API_DOC_META_DATA adm WHERE ar.ORGANIZATION=? AND ad.RESOURCE_CONTENT @@ to_tsquery(?) AND ad.API_ID=ar.API_UUID AND ad.UUID=adm.RESOURCE_UUID  AND ar.ARTIFACT @> '{\"status\": \"PUBLISHED\"}';";
        ...
        public static final String RETRIEVE_DEFAULT_VERSION = "SELECT DEFAULT_API_VERSION,PUBLISHED_DEFAULT_API_VERSION " +
                "FROM API_DEFAULT_VERSION WHERE API_NAME = ? AND API_PROVIDER =?";
        ...
        public static final String ADD_API_REVISION_METADATA = "INSERT INTO API_REVISION_METADATA (API_UUID," +
                "REVISION_UUID,API_TIER,ARTIFACT) SELECT ?, ?, API_TIER, ARTIFACT FROM API WHERE API_UUID = ?";
        public static final String ADD_REVISION_API_ARTIFACTS = "INSERT INTO API_ARTIFACT (ORGANIZATION,API_UUID,API_DEFINITION,MEDIA_TYPE) " +
                "SELECT ORGANIZATION,?,API_DEFINITION,MEDIA_TYPE FROM API_ARTIFACT WHERE API_UUID=?";
        public static final String UPDATE_FULL_API_ARTIFACT_SQL= "UPDATE API SET ARTIFACT=TO_JSON(?::JSON) WHERE ORGANIZATION=? AND API_UUID=?;";
        public static final String DELETE_API_DEFINITION_SQL = "DELETE FROM API_ARTIFACT WHERE ORGANIZATION=? AND API_UUID=?;";
        ...
        public static final String RESTORE_API_REVISION_METADATA = "UPDATE API SET (API_TIER,ARTIFACT) = (SELECT API_TIER,ARTIFACT FROM " +
        ...
        public static class ThrottleSQLConstants{
            ...
            public static final String ADD_BLOCK_CONDITION_SQL =
                    "INSERT INTO BLOCK_CONDITION (TYPE,BLOCK_CONDITION,ENABLED,DOMAIN,UUID) VALUES (?,?,?,?,?)";
            ...
            public static final String BLOCK_CONDITION_EXIST_SQL =
                    "SELECT CONDITION_ID,TYPE,BLOCK_CONDITION,ENABLED,DOMAIN,UUID FROM BLOCK_CONDITION WHERE ORGANIZATION =? "
                            + "AND TYPE =? AND BLOCK_CONDITION =?";
            public static final String GET_SUBSCRIPTION_BLOCK_CONDITION_BY_VALUE_AND_DOMAIN_SQL =
                    "SELECT CONDITION_ID,TYPE,BLOCK_CONDITION,ENABLED,DOMAIN,UUID FROM BLOCK_CONDITION WHERE "
        ...
        public static class WebhooksSqlConstants {
            ...
            public static final String GET_THROTTLE_LIMIT =
                    "SELECT CONNECTIONS_COUNT FROM BUSINESS_PLAN WHERE NAME = ? AND TENANT_ID = ?";
        ...
        public static class TenantThemeConstants {
            ...
            public static final String ADD_TENANT_THEME = "INSERT INTO TENANT_THEMES (TENANT_ID, THEME) VALUES (?,?)";
            public static final String UPDATE_TENANT_THEME = "UPDATE TENANT_THEMES SET THEME = ? WHERE TENANT_ID = ?";
            public static final String DELETE_TENANT_THEME = "DELETE FROM TENANT_THEMES WHERE TENANT_ID = ?";
            public static final String GET_TENANT_THEME = "SELECT * FROM TENANT_THEMES WHERE TENANT_ID = ?";
        }
        ...
        public static class APIRevisionSqlConstants {
            ...
            public static final String RESTORE_API_REVISION_DEFINITION = "UPDATE API_ARTIFACT SET (API_DEFINITION, MEDIA_TYPE) =" +
                        " (SELECT API_DEFINITION, MEDIA_TYPE FROM API_ARTIFACT " +
                        " WHERE API_UUID=?) WHERE API_UUID=?";

            public static final String DELETE_API_REVISION_DEFINITION = "DELETE FROM API_ARTIFACT WHERE API_UUID=?;";
        }
        ...
        /**
         * Static class to hold database queries related to API Documents
         */
        public static class APIDocumentConstants {
                public static final String ADD_DOCUMENT_SQL = "INSERT INTO API_DOC_META_DATA (UUID, RESOURCE_UUID, NAME, SUMMARY, TYPE, OTHER_TYPE_NAME, " +
                        "SOURCE_URL, FILE_NAME, SOURCE_TYPE, VISIBILITY, CREATED_BY, UPDATED_BY) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";

                public static final String UPDATE_DOCUMENT_SQL = "UPDATE API_DOC_META_DATA SET NAME=?, SUMMARY=?, TYPE=?, OTHER_TYPE_NAME=?, " +
                        "SOURCE_URL=?, FILE_NAME=?, SOURCE_TYPE=?, VISIBILITY=?, CREATED_BY=?, UPDATED_BY=? WHERE UUID=?";

                public static final String GET_DOCUMENT_SQL = "SELECT API_DOC_META_DATA.UUID, API_DOC_META_DATA.NAME, API_DOC_META_DATA" +
                        ".SUMMARY, API_DOC_META_DATA.TYPE, API_DOC_META_DATA.OTHER_TYPE_NAME, API_DOC_META_DATA" +
                        ".SOURCE_URL, API_DOC_META_DATA.FILE_NAME, API_DOC_META_DATA.SOURCE_TYPE, API_DOC_META_DATA" +
                        ".VISIBILITY, API_DOC_META_DATA.CREATED_TIME, API_DOC_META_DATA.LAST_UPDATED_TIME FROM API_DOC_META_DATA WHERE API_DOC_META_DATA.UUID = ?";

                public static final String GET_DOCUMENT_CONTENT_SQL = "SELECT ar.RESOURCE_BINARY_VALUE,ar.DATA_TYPE,am.SOURCE_URL,am.FILE_NAME FROM API_RESOURCES ar, API_DOC_META_DATA am  WHERE ar.API_ID=? AND ar.UUID=am.RESOURCE_UUID AND am.UUID=?;";

                public static final String ADD_DOCUMENT_CONTENT_SQL = "UPDATE API_RESOURCES AS ar SET RESOURCE_BINARY_VALUE = ?, RESOURCE_CONTENT=TO_TSVECTOR(?), DATA_TYPE = ?, UPDATED_BY = ?, "
                        + "LAST_UPDATED_TIME = ? FROM API_DOC_META_DATA am WHERE am.UUID = ? AND am.RESOURCE_UUID=ar.UUID";

                public static final String SEARCH_ALL_DOC_SQL = "SELECT API_DOC_META_DATA.UUID, API_DOC_META_DATA.NAME, API_DOC_META_DATA" +
                        ".SUMMARY, API_DOC_META_DATA.TYPE, API_DOC_META_DATA.OTHER_TYPE_NAME, API_DOC_META_DATA" +
                        ".SOURCE_URL, API_DOC_META_DATA.FILE_NAME, API_DOC_META_DATA.SOURCE_TYPE, API_DOC_META_DATA" +
                        ".VISIBILITY, API_DOC_META_DATA.CREATED_TIME, API_DOC_META_DATA.LAST_UPDATED_TIME " +
                        "FROM API_DOC_META_DATA, API_RESOURCES WHERE API_DOC_META_DATA.RESOURCE_UUID=API_RESOURCES.UUID AND API_RESOURCES.API_ID=?;";

                public static final String DELETE_DOC_META_DATA_SQL = "DELETE FROM API_DOC_META_DATA WHERE UUID=?";

                public static final String DELETE_DOC_RESOURCE_SQL = "DELETE FROM API_RESOURCES WHERE API_ID = ? AND UUID = (SELECT RESOURCE_UUID FROM API_DOC_META_DATA WHERE UUID=?)";


        }

        /**
         * Static class to hold database queries related to API Resources
         */
        public static class APIResourceConstants {
                public static final String ADD_API_RESOURCES_SQL = "INSERT INTO API_RESOURCES (UUID, API_ID, RESOURCE_CATEGORY_ID) VALUES (?,?,?)";

                public static final String ADD_BINARY_RESOURCES_SQL = "INSERT INTO API_RESOURCES (UUID, API_ID, RESOURCE_CATEGORY_ID, " +
                        "DATA_TYPE, RESOURCE_BINARY_VALUE, CREATED_BY, CREATED_TIME, UPDATED_BY, LAST_UPDATED_TIME) "
                        + "VALUES (?,?,?,?,?,?,?,?,?)";

                public static final String GET_THUMBNAIL_SQL = "SELECT DATA_TYPE,RESOURCE_BINARY_VALUE FROM API_RESOURCES " +
                        "WHERE API_ID = ? AND RESOURCE_CATEGORY_ID = ?";

                public static final String GET_BINARY_VALUE_BY_CATEGORY_SQL = "SELECT RESOURCE_BINARY_VALUE FROM API_RESOURCES " +
                        "WHERE API_ID = ? AND RESOURCE_CATEGORY_ID = ?)";

                public static final String RESOURCE_EXIST_CHECK_SQL = "SELECT 1 FROM API_RESOURCES WHERE API_ID = ? AND RESOURCE_CATEGORY_ID = ?";

                public static final String UPDATE_BINARY_RESOURCE_SQL = "UPDATE API_RESOURCES SET RESOURCE_BINARY_VALUE = ?, UPDATED_BY = ?, "
                        + "LAST_UPDATED_TIME = ? WHERE API_ID = ? AND RESOURCE_CATEGORY_ID = ?";

                public static final String DELETE_UNIQUE_RESOURCE_BY_CATEGORY_SQL = "DELETE FROM API_RESOURCES WHERE API_ID = ? AND RESOURCE_CATEGORY_ID = ?";
        }
