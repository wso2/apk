...
public class PostgreSQLConstants {
        ...
        public static final String GET_API_ARTIFACT_SQL = "SELECT ap.ARTIFACT, ar.API_DEFINITION, ar.MEDIA_TYPE FROM AM_API ap," +
                " AM_API_ARTIFACT ar WHERE ap.ORGANIZATION=ar.ORGANIZATION AND ap.API_UUID=ar.API_UUID AND ar.API_UUID=? AND ar.ORGANIZATION=?;";

        public static final String GET_DEVPORTAL_API_ARTIFACT_SQL = "SELECT ap.ARTIFACT, ar.API_DEFINITION, ar.MEDIA_TYPE FROM AM_API ap," +
                " AM_API_ARTIFACT ar WHERE ap.ORGANIZATION=ar.ORGANIZATION AND ap.API_UUID=ar.API_UUID AND ar.API_UUID=? AND ar.ORGANIZATION=? AND ap.ARTIFACT @> '{\"status\": \"PUBLISHED\"}';";

        public static final String GET_REVISION_API_ARTIFACT_SQL = "SELECT am.ARTIFACT, ar.API_DEFINITION, ar.MEDIA_TYPE FROM AM_API_REVISION_METADATA am," +
                " AM_API_ARTIFACT ar WHERE am.REVISION_UUID=ar.API_UUID AND am.REVISION_UUID=? AND ar.ORGANIZATION=?;";

        public static final String UPDATE_API_DEFINITION_SQL = "UPDATE AM_API_ARTIFACT SET API_DEFINITION=?,MEDIA_TYPE=? WHERE ORGANIZATION=? AND API_UUID=?;";

        public static final String GET_API_DEFINITION_SQL = "SELECT API_DEFINITION,MEDIA_TYPE from AM_API_ARTIFACT WHERE ORGANIZATION=? AND API_UUID=?;";
        public static final String SEARCH_ALL_APIS_SQL = "SELECT ARTIFACT, API_UUID FROM AM_API WHERE ORGANIZATION=?;";
        ...
        public static final String SEARCH_API_CONTENT_SQL = "SELECT DISTINCT ARTIFACT,API_UUID FROM AM_API JOIN JSONB_EACH_TEXT(ARTIFACT) e ON TRUE \n" +
        ...
        public static final String UPDATE_API_ARTIFACT_SQL = "UPDATE AM_API SET ARTIFACT[?] = TO_JSONB(?) WHERE ORGANIZATION=? AND API_UUID=?;";

        public static final String SEARCH_ALL_DEVPORTAL_SQL = "SELECT ARTIFACT, API_UUID FROM AM_API WHERE ORGANIZATION=? AND ARTIFACT @> '{\"status\": \"PUBLISHED\"}';";

        public static final String SEARCH_ALL_CONTENT_DEVPORTAL_SQL = "SELECT DISTINCT ARTIFACT,API_UUID FROM AM_API JOIN JSONB_EACH_TEXT(ARTIFACT) e ON TRUE \n" +
        ...
        public static final String ADD_API_REVISION_METADATA = "INSERT INTO AM_API_REVISION_METADATA (API_UUID," +
                "REVISION_UUID,API_TIER,ARTIFACT) SELECT ?, ?, API_TIER, ARTIFACT FROM AM_API WHERE API_UUID = ?";
        public static final String ADD_REVISION_API_ARTIFACTS = "INSERT INTO AM_API_ARTIFACT (ORGANIZATION,API_UUID,API_DEFINITION,MEDIA_TYPE) " +
                "SELECT ORGANIZATION,?,API_DEFINITION,MEDIA_TYPE FROM AM_API_ARTIFACT WHERE API_UUID=?";
        public static final String UPDATE_FULL_API_ARTIFACT_SQL= "UPDATE AM_API SET ARTIFACT=TO_JSON(?::JSON) WHERE ORGANIZATION=? AND API_UUID=?;";
        public static final String DELETE_API_DEFINITION_SQL = "DELETE FROM AM_API_ARTIFACT WHERE ORGANIZATION=? AND API_UUID=?;";
        ...
        public static final String RESTORE_API_REVISION_METADATA = "UPDATE AM_API SET (API_TIER,ARTIFACT) = (SELECT API_TIER,ARTIFACT FROM " +
        ...
        public static class ThrottleSQLConstants{
            ...
            public static final String BLOCK_CONDITION_EXIST_SQL =
                    "SELECT CONDITION_ID,TYPE,BLOCK_CONDITION,ENABLED,DOMAIN,UUID FROM AM_BLOCK_CONDITIONS WHERE ORGANIZATION =? "
        ...
        public static class APIRevisionSqlConstants {
            ...
            public static final String RESTORE_API_REVISION_DEFINITION = "UPDATE AM_API_ARTIFACT SET (API_DEFINITION, MEDIA_TYPE) =" +
                        " (SELECT API_DEFINITION, MEDIA_TYPE FROM AM_API_ARTIFACT " +
                        " WHERE API_UUID=?) WHERE API_UUID=?";

            public static final String DELETE_API_REVISION_DEFINITION = "DELETE FROM AM_API_ARTIFACT WHERE API_UUID=?;";
        }
        ...
        public static class APIDocumentConstants {
                public static final String ADD_DOCUMENT_SQL = "INSERT INTO AM_API_DOC_META_DATA (UUID, RESOURCE_UUID, NAME, SUMMARY, TYPE, OTHER_TYPE_NAME, " +
                        "SOURCE_URL, FILE_NAME, SOURCE_TYPE, VISIBILITY, CREATED_BY, UPDATED_BY) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";

                public static final String UPDATE_DOCUMENT_SQL = "UPDATE AM_API_DOC_META_DATA SET NAME=?, SUMMARY=?, TYPE=?, OTHER_TYPE_NAME=?, " +
                        "SOURCE_URL=?, FILE_NAME=?, SOURCE_TYPE=?, VISIBILITY=?, CREATED_BY=?, UPDATED_BY=? WHERE UUID=?";

                public static final String GET_DOCUMENT_SQL = "SELECT AM_API_DOC_META_DATA.UUID, AM_API_DOC_META_DATA.NAME, AM_API_DOC_META_DATA" +
                ...
                public static final String GET_DOCUMENT_CONTENT_SQL = "SELECT ar.RESOURCE_BINARY_VALUE,ar.DATA_TYPE,am.SOURCE_URL,am.FILE_NAME FROM AM_API_RESOURCES ar, AM_API_DOC_META_DATA am  WHERE ar.API_ID=? AND ar.UUID=am.RESOURCE_UUID AND am.UUID=?;";

                public static final String ADD_DOCUMENT_CONTENT_SQL = "UPDATE AM_API_RESOURCES AS ar SET RESOURCE_BINARY_VALUE = ?, RESOURCE_CONTENT=TO_TSVECTOR(?), DATA_TYPE = ?, UPDATED_BY = ?, "
                        + "LAST_UPDATED_TIME = ? FROM AM_API_DOC_META_DATA am WHERE am.UUID = ? AND am.RESOURCE_UUID=ar.UUID";

                public static final String SEARCH_ALL_DOC_SQL = "SELECT AM_API_DOC_META_DATA.UUID, AM_API_DOC_META_DATA.NAME, AM_API_DOC_META_DATA" +
                        ".SUMMARY, AM_API_DOC_META_DATA.TYPE, AM_API_DOC_META_DATA.OTHER_TYPE_NAME, AM_API_DOC_META_DATA" +
                        ".SOURCE_URL, AM_API_DOC_META_DATA.FILE_NAME, AM_API_DOC_META_DATA.SOURCE_TYPE, AM_API_DOC_META_DATA" +
                ...
                public static final String DELETE_DOC_META_DATA_SQL = "DELETE FROM AM_API_DOC_META_DATA WHERE UUID=?";

                public static final String DELETE_DOC_RESOURCE_SQL = "DELETE FROM AM_API_RESOURCES WHERE API_ID = ? AND UUID = (SELECT RESOURCE_UUID FROM AM_API_DOC_META_DATA WHERE UUID=?)";
        ...
        public static class APIResourceConstants {
                public static final String ADD_API_RESOURCES_SQL = "INSERT INTO AM_API_RESOURCES (UUID, API_ID, RESOURCE_CATEGORY_ID) VALUES (?,?,?)";

                public static final String ADD_BINARY_RESOURCES_SQL = "INSERT INTO AM_API_RESOURCES (UUID, API_ID, RESOURCE_CATEGORY_ID, " +
                        "DATA_TYPE, RESOURCE_BINARY_VALUE, CREATED_BY, CREATED_TIME, UPDATED_BY, LAST_UPDATED_TIME) "
                        + "VALUES (?,?,?,?,?,?,?,?,?)";

                public static final String GET_THUMBNAIL_SQL = "SELECT DATA_TYPE,RESOURCE_BINARY_VALUE FROM AM_API_RESOURCES " +
                        "WHERE API_ID = ? AND RESOURCE_CATEGORY_ID = ?";

                public static final String GET_BINARY_VALUE_BY_CATEGORY_SQL = "SELECT RESOURCE_BINARY_VALUE FROM AM_API_RESOURCES " +
                        "WHERE API_ID = ? AND RESOURCE_CATEGORY_ID = ?)";

                public static final String RESOURCE_EXIST_CHECK_SQL = "SELECT 1 FROM AM_API_RESOURCES WHERE API_ID = ? AND RESOURCE_CATEGORY_ID = ?";

                public static final String UPDATE_BINARY_RESOURCE_SQL = "UPDATE AM_API_RESOURCES SET RESOURCE_BINARY_VALUE = ?, UPDATED_BY = ?, "
                        + "LAST_UPDATED_TIME = ? WHERE API_ID = ? AND RESOURCE_CATEGORY_ID = ?";

                public static final String DELETE_UNIQUE_RESOURCE_BY_CATEGORY_SQL = "DELETE FROM AM_API_RESOURCES WHERE API_ID = ? AND RESOURCE_CATEGORY_ID = ?";
        }
