...
import (
	...
	config "github.com/wso2/apk/common-adapter/internal/config"
)
...
func GetKeyLocations() (string, string, string) {
	...
	publicKeyLocation := conf.CommonAdapter.Keystore.CertPath
	privateKeyLocation := conf.CommonAdapter.Keystore.KeyPath
	truststoreLocation := conf.CommonAdapter.Truststore.Location
