...
func getGzipConfigurations(config config.Config) *gzip_compressor.Gzip {
	...
	if memoryLevel != 0 {
		...
		logger.LoggerXds.ErrorC(logging.GetErrorByCode(logging.Error2235, err1.Error()))
	}
	...
	if windowBits != 0 && err2 == nil {
		...
		logger.LoggerXds.ErrorC(logging.GetErrorByCode(logging.Error2236, err2.Error()))
	}
	...
	if compressionLevel != 0 && err3 == nil {
		...
		logger.LoggerXds.ErrorC(logging.GetErrorByCode(logging.Error2237, err3.Error()))
	}
	...
	if chunkSize != 0 && err4 == nil {
		...
		logger.LoggerXds.ErrorC(logging.GetErrorByCode(logging.Error2238, err4.Error()))
	}
