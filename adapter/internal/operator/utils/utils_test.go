...
func TestTieBreaker(t *testing.T) {
	...
	type testItem struct {
		objectList     []*dpv1alpha5.Backend
		expectedObject *dpv1alpha5.Backend
		message        string
	}
	...
	policy1 := dpv1alpha5.Backend{
		ObjectMeta: metav1.ObjectMeta{
			Namespace:         "default",
			Name:              "policy-1",
			CreationTimestamp: metav1.NewTime(newTime),
		},
		Spec: dpv1alpha5.BackendSpec{
			Protocol: dpv1alpha5.HTTPProtocol,
		},
	}

	policy2 := dpv1alpha5.Backend{
		ObjectMeta: metav1.ObjectMeta{
			Namespace:         "default",
			Name:              "policy-2",
