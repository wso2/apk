...
func (t *Translator) ProcessListeners(gateways []*GatewayContext, xdsIR XdsIRMap, infraIR InfraIRMap, resources *Resources) {
	...
	for _, gateway := range gateways {
		...
		xdsIR[irKey].AccessLog = processAccessLog()
		xdsIR[irKey].Tracing = processTracing()
		xdsIR[irKey].Metrics = processMetrics()
...
func processAccessLog() *ir.AccessLog {
...
func processTracing() *ir.Tracing {
	return nil
}

func processMetrics() *ir.Metrics {
	return nil
}
