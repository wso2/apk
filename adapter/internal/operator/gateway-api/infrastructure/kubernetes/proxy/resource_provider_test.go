...
// 					},
// 				},
// 				EnvoyProxyContainer: &egv1a1.KubernetesContainerSpec{
...
// 					},
// 				},
// 				EnforcerContainer: &egv1a1.KubernetesContainerSpec{
// 					Image: ptr.To("wso2/apk-enforcer:1.1.0"),
// 					Resources: &corev1.ResourceRequirements{
// 						Limits: corev1.ResourceList{
// 							corev1.ResourceCPU:    resource.MustParse("400m"),
// 							corev1.ResourceMemory: resource.MustParse("2Gi"),
...
// 					// 	},
// 					// },
// 					Image: ptr.To("wso2/apk-enforcer:1.1.0-ubuntu"),
// 					Resources: &corev1.ResourceRequirements{
// 						Limits: corev1.ResourceList{
// 							corev1.ResourceCPU:    resource.MustParse("400m"),
// 							corev1.ResourceMemory: resource.MustParse("2Gi"),
...
// 				EnforcerContainer: &egv1a1.KubernetesContainerSpec{
// 					Env:   nil,
// 					Image: ptr.To("wso2/enforcer:1.1.0"),
// 					Resources: &corev1.ResourceRequirements{
// 						Limits: corev1.ResourceList{
// 							corev1.ResourceCPU:    resource.MustParse("400m"),
// 							corev1.ResourceMemory: resource.MustParse("2Gi"),
...
// 			r := NewResourceRender(defaultNamespace, tc.infra.GetProxyInfra())
// 			dp, err := r.Deployment()
...
// 			assert.Equal(t, expected, dp, "failed "+tc.caseName)
// 		})
// 	}
// }
...
// 			labels: map[string]string{
// 				"apk.wso2.com/owning-gatewayclass": "eg-class",
// 			},
// 			expect: false,
// 		},
// 		{
...
// 			labels: map[string]string{
// 				"apk.wso2.com/owning-gateway-name":      "eg",
