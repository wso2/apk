	...
	env := []corev1.EnvVar{
		{
			...
			Value: "apk-test-wso2-apk-adapter-service.apk.svc",
		},
		{
			Name:  "ADAPTER_HOST",
			Value: "apk-test-wso2-apk-adapter-service.apk.svc",
		},
		{
			...
			Value: "apk-test-wso2-apk-common-controller-service.apk.svc",
		},
		{
		...
		},
		{
			...
			Value: "apk-test-wso2-apk-enforcer-service.apk.svc",
		},
		{
