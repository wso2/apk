...
import (
	...
	"github.com/wso2/apk/adapter/internal/operator/gateway-api/types"
...
type TLSVersion types.TLSVersion

const (
	// TLSAuto allows Envoy to choose the optimal TLS Version
	TLSAuto = TLSVersion(types.TLSAuto)
	// TLSv10 specifies TLS version 1.0
	TLSv10 = TLSVersion(types.TLSv10)
	// TLSv11 specifies TLS version 1.1
	TLSv11 = TLSVersion(types.TLSv11)
	// TLSv12 specifies TLS version 1.2
	TLSv12 = TLSVersion(types.TLSv12)
	// TLSv13 specifies TLS version 1.3
	TLSv13 = TLSVersion(types.TLSv13)
)
