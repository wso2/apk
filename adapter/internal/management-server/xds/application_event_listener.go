...
// 					loggers.LoggerXds.ErrorC(logging.PrintError(logging.Error1707, logging.CRITICAL, "Error creating application: %v", err.Error()))
// 				} else {
...
// 				if err != nil {
// 					loggers.LoggerXds.ErrorC(logging.PrintError(logging.Error1709, logging.CRITICAL, "Error updating application: %v", err.Error()))
// 				} else {
...
// 			if err != nil {
// 				loggers.LoggerXds.ErrorC(logging.PrintError(logging.Error1710, logging.CRITICAL, "Error deleting application: %v", err.Error()))
// 			} else {
...
// 					loggers.LoggerXds.ErrorC(logging.PrintError(logging.Error1711, logging.CRITICAL, "Error retrieving application: %v", err.Error()))
