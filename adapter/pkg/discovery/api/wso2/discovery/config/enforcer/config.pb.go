...
type Config struct {
	...
	EnforcerEnabled 			  bool          `protobuf:"varint,17,opt,name=enforcerEnabled,proto3" json:"enforcerEnabled,omitempty"`
}
...
func (x *Config) IsEnforcerEnabled() bool {
	if x != nil {
		return x.EnforcerEnabled
	}
	return false
}
