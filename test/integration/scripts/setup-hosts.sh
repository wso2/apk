...
sudo echo "$IP all-http-methods-for-wildcard-contentlength.test.gw.wso2.com" | sudo tee -a /etc/hosts
sudo echo "$IP all-http-methods-for-wildcard-piimasking.test.gw.wso2.com" | sudo tee -a /etc/hosts
