...
public class Constants {
    ...
    public static final String DEFAULT_API_CONFIGURATOR = "api/configurator/1.2.0/";
    public static final String DEFAULT_API_DEPLOYER = "api/deployer/1.2.0/";
    ...
    public static final String DEFAULT_APIM_API_CONFIGURATOR = "api/configurator/1.2.0/";
