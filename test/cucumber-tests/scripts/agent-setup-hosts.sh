...
kubectl wait --timeout=5m -n apk deployment/apk-adapter --for=condition=Available
kubectl wait --timeout=15m -n apk deployment/apk-gateway-runtime --for=condition=Available
