...
import { REQUEST_STATUS, ACCESS_TOKEN, REQUESTED_PATH } from 'auth/constants/token';
...
const requestParams: OIDCRequestParamsInterface = {
  clientId: Settings.idp.IDP_CLIENT_ID,
  scope: Settings.idp.scope,
  state: Settings.idp.state,
  serverOrigin: Settings.idp.serverOrigin
};
...
export const AuthProvider = ({ children }: AuthProviderProps) => {
  ...
  const handleLogin = () => {
    ...
    initOPConfiguration(Settings.idp.wellKnown, false).then(() => {
