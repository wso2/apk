...
package org.wso2.apk.apimgt.admin.utils.mappings;
...
import org.wso2.apk.apimgt.admin.dto.KeyManagerConfigurationDTO;
import org.wso2.apk.apimgt.admin.dto.SettingsDTO;
import org.wso2.apk.apimgt.admin.dto.SettingsKeyManagerConfigurationInnerDTO;
...
public class SettingsMappingUtil {
    ...
    private List<SettingsKeyManagerConfigurationInnerDTO> getSettingsKeyManagerConfigurationDTOList() {
        List<SettingsKeyManagerConfigurationInnerDTO> list = new ArrayList<>();
    ...
    private static SettingsKeyManagerConfigurationInnerDTO fromKeyManagerConfigurationToSettingsKeyManagerConfigurationDTO(
        ...
        SettingsKeyManagerConfigurationInnerDTO settingsKeyManagerConfigurationDTO =
                new SettingsKeyManagerConfigurationInnerDTO();
