...
public class KeyManagerMappingUtil {
    ...
    public static KeyManagerConfigurationDTO toKeyManagerConfigurationDTO(String tenantDomain,
        ...
        additionalProperties
                .put(APIConstants.KeyManager.ENABLE_OAUTH_APP_CREATION, keyManagerDTO.getEnableOAuthAppCreation());
        additionalProperties.put(APIConstants.KeyManager.ENABLE_MAP_OAUTH_CONSUMER_APPS,
                keyManagerDTO.getEnableMapOAuthConsumerApps());

        additionalProperties
                .put(APIConstants.KeyManager.ENABLE_TOKEN_GENERATION, keyManagerDTO.getEnableTokenGeneration());
