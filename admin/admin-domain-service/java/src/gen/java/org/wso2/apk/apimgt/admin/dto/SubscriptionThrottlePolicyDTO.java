...
import org.wso2.apk.apimgt.admin.dto.CustomAttributeDTO;
import org.wso2.apk.apimgt.admin.dto.MonetizationInfoDTO;
import org.wso2.apk.apimgt.admin.dto.SubscriptionThrottlePolicyPermissionDTO;
...
public class SubscriptionThrottlePolicyDTO extends ThrottlePolicyDTO  {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(graphQLMaxComplexity, graphQLMaxDepth, defaultLimit, monetization, rateLimitCount, rateLimitTimeUnit, subscriberCount, customAttributes, stopOnQuotaReach, billingPlan, permissions, super.hashCode());
  }
