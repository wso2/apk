...
@JsonSubTypes({
  @JsonSubTypes.Type(value = AdvancedThrottlePolicyDTO.class, name = "AdvancedThrottlePolicy"),
  @JsonSubTypes.Type(value = AdvancedThrottlePolicyInfoDTO.class, name = "AdvancedThrottlePolicyInfo"),
  @JsonSubTypes.Type(value = ApplicationThrottlePolicyDTO.class, name = "ApplicationThrottlePolicy"),
  @JsonSubTypes.Type(value = SubscriptionThrottlePolicyDTO.class, name = "SubscriptionThrottlePolicy"),
})
