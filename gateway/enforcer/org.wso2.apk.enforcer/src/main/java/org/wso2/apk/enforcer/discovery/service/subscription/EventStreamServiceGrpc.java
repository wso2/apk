...
public final class EventStreamServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.wso2.apk.enforcer.discovery.service.subscription.Request,
      org.wso2.apk.enforcer.discovery.subscription.Event> getStreamEventsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamEvents",
      requestType = org.wso2.apk.enforcer.discovery.service.subscription.Request.class,
      responseType = org.wso2.apk.enforcer.discovery.subscription.Event.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<org.wso2.apk.enforcer.discovery.service.subscription.Request,
      org.wso2.apk.enforcer.discovery.subscription.Event> getStreamEventsMethod() {
    io.grpc.MethodDescriptor<org.wso2.apk.enforcer.discovery.service.subscription.Request, org.wso2.apk.enforcer.discovery.subscription.Event> getStreamEventsMethod;
      ...
      synchronized (EventStreamServiceGrpc.class) {
        if ((getStreamEventsMethod = EventStreamServiceGrpc.getStreamEventsMethod) == null) {
          EventStreamServiceGrpc.getStreamEventsMethod = getStreamEventsMethod =
              io.grpc.MethodDescriptor.<org.wso2.apk.enforcer.discovery.service.subscription.Request, org.wso2.apk.enforcer.discovery.subscription.Event>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "StreamEvents"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.wso2.apk.enforcer.discovery.service.subscription.Request.getDefaultInstance()))
  ...
  public static abstract class EventStreamServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void streamEvents(org.wso2.apk.enforcer.discovery.service.subscription.Request request,
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                org.wso2.apk.enforcer.discovery.service.subscription.Request,
  ...
  public static final class EventStreamServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<EventStreamServiceBlockingStub> {
    ...
    public java.util.Iterator<org.wso2.apk.enforcer.discovery.subscription.Event> streamEvents(
        org.wso2.apk.enforcer.discovery.service.subscription.Request request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_STREAM_EVENTS:
          serviceImpl.streamEvents((org.wso2.apk.enforcer.discovery.service.subscription.Request) request,
              (io.grpc.stub.StreamObserver<org.wso2.apk.enforcer.discovery.subscription.Event>) responseObserver);
          break;
        default:
  ...
  private static abstract class EventStreamServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.wso2.apk.enforcer.discovery.service.subscription.EventServiceProto.getDescriptor();
    }
