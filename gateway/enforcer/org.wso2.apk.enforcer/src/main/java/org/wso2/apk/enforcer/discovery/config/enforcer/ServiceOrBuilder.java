...
public interface ServiceOrBuilder extends
   ...
   */
  org.wso2.apk.enforcer.discovery.config.enforcer.ThreadPool getThreadPool();
  /**
   * <code>.wso2.discovery.config.enforcer.ThreadPool threadPool = 5;</code>
   */
  org.wso2.apk.enforcer.discovery.config.enforcer.ThreadPoolOrBuilder getThreadPoolOrBuilder();
}
