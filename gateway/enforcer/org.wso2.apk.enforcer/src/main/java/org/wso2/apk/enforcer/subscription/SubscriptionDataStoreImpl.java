...
import org.wso2.apk.discovery.subscription.APIs;
...
public class SubscriptionDataStoreImpl implements SubscriptionDataStore {
    ...
    public void addSubscriptions(List<org.wso2.apk.discovery.subscription.Subscription> subscriptionList) {
        Map<String, Subscription> newSubscriptionMap = new ConcurrentHashMap<>();

        for (org.wso2.apk.discovery.subscription.Subscription subscription : subscriptionList) {
    ...
    public void addApplications(List<org.wso2.apk.discovery.subscription.Application> applicationList) {
        Map<String, Application> newApplicationMap = new ConcurrentHashMap<>();

        for (org.wso2.apk.discovery.subscription.Application application : applicationList) {
    ...
    public void addApplicationPolicies(
            List<org.wso2.apk.discovery.subscription.ApplicationPolicy> applicationPolicyList) {
        Map<String, ApplicationPolicy> newAppPolicyMap = new ConcurrentHashMap<>();

        for (org.wso2.apk.discovery.subscription.ApplicationPolicy applicationPolicy :
    ...
    public void addSubscriptionPolicies(
            List<org.wso2.apk.discovery.subscription.SubscriptionPolicy> subscriptionPolicyList) {
        Map<String, SubscriptionPolicy> newSubscriptionPolicyMap = new ConcurrentHashMap<>();

        for (org.wso2.apk.discovery.subscription.SubscriptionPolicy subscriptionPolicy :
    ...
    public void addApplicationKeyMappings(
            List<org.wso2.apk.discovery.subscription.ApplicationKeyMapping> applicationKeyMappingList) {
        Map<ApplicationKeyMappingCacheKey, ApplicationKeyMapping> newApplicationKeyMappingMap =
                new ConcurrentHashMap<>();

        for (org.wso2.apk.discovery.subscription.ApplicationKeyMapping applicationKeyMapping :
