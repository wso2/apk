...
import org.wso2.apk.discovery.api.EndpointClusterConfig;
import org.wso2.apk.discovery.api.Operation;
import org.wso2.apk.discovery.api.OperationPolicies;
...
public class Utils {
     ...
     */
    public static EndpointCluster processEndpoints(org.wso2.apk.discovery.api.EndpointCluster
                                                           rpcEndpointCluster) {
        ...
        if (rpcEndpointCluster.hasConfig()) {
            ...
            if (endpointClusterConfig.hasRetryConfig()) {
                org.wso2.apk.discovery.api.RetryConfig rpcRetryConfig
            ...
            if (endpointClusterConfig.hasTimeoutConfig()) {
                org.wso2.apk.discovery.api.TimeoutConfig timeoutConfig
    ...
    private static ArrayList<Policy> genPolicyList
            (List<org.wso2.apk.discovery.api.Policy> operationPoliciesList) {
        ArrayList<Policy> policyList = new ArrayList<>();
        for (org.wso2.apk.discovery.api.Policy policy : operationPoliciesList) {
