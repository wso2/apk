...
public final class ApiProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\020 \001(\010\022\021\n\tsystemAPI\030\021 \001(\010\022D\n\023backendJWTT" +
      "okenInfo\030\022 \001(\0132\'.wso2.discovery.api.Back" +
    ...
    internal_static_wso2_discovery_api_Api_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_wso2_discovery_api_Api_descriptor,
        new java.lang.String[] { "Id", "Title", "Version", "ApiType", "DisableAuthentications", "DisableScopes", "EnvType", "Resources", "BasePath", "Tier", "ApiLifeCycleState", "Vhost", "OrganizationId", "ClientCertificates", "MutualSSL", "ApplicationSecurity", "SystemAPI", "BackendJWTTokenInfo", });
    org.wso2.apk.enforcer.discovery.api.ResourceProto.getDescriptor();
    org.wso2.apk.enforcer.discovery.api.CertificateProto.getDescriptor();
    org.wso2.apk.enforcer.discovery.api.BackendJWTTokenInfoProto.getDescriptor();
  }
