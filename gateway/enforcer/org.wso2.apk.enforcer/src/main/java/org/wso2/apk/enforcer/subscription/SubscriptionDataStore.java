...
public interface SubscriptionDataStore {
    ...
    void addSubscriptions(List<org.wso2.apk.discovery.subscription.Subscription> subscriptionList);

    void addApplications(List<org.wso2.apk.discovery.subscription.Application> applicationList);
