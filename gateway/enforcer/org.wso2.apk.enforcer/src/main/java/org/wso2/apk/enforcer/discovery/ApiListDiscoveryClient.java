...
import org.wso2.apk.enforcer.discovery.service.subscription.ApiListDiscoveryServiceGrpc;
import org.wso2.apk.enforcer.discovery.subscription.APIList;
...
public class ApiListDiscoveryClient implements Runnable {
    ...
    private ApiListDiscoveryClient(String host, String hostname, int port) {
        this.host = host;
    ...
    public static ApiListDiscoveryClient getInstance() {
        if (instance == null) {
            ...
            instance = new ApiListDiscoveryClient(sdsHost, sdsHostname, sdsPort);
        }
        return instance;
    }
