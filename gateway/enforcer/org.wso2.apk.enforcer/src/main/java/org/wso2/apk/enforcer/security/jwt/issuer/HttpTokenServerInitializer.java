...
/**
 * This is the http token server initializer implementation.
 */
public class HttpTokenServerInitializer extends ChannelInitializer<SocketChannel> {
    private final SslContext sslCtx;

    public HttpTokenServerInitializer(SslContext sslCtx) {
        this.sslCtx = sslCtx;
    }
