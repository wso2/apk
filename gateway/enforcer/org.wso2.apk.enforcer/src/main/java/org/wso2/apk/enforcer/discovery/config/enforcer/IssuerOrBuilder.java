...
public interface IssuerOrBuilder extends
   ...
   */
  java.util.List<org.wso2.apk.enforcer.discovery.config.enforcer.ClaimMapping> 
      getClaimMappingList();
  /**
   * <pre>
   * Claim mapping for the issuer
   ...
   * <code>repeated .wso2.discovery.config.enforcer.ClaimMapping claimMapping = 8;</code>
   */
  org.wso2.apk.enforcer.discovery.config.enforcer.ClaimMapping getClaimMapping(int index);
  /**
   * <pre>
   * Claim mapping for the issuer
   * </pre>
   ...
   * <code>repeated .wso2.discovery.config.enforcer.ClaimMapping claimMapping = 8;</code>
   */
  java.util.List<? extends org.wso2.apk.enforcer.discovery.config.enforcer.ClaimMappingOrBuilder> 
   ...
   * <code>repeated .wso2.discovery.config.enforcer.ClaimMapping claimMapping = 8;</code>
   */
  org.wso2.apk.enforcer.discovery.config.enforcer.ClaimMappingOrBuilder getClaimMappingOrBuilder(
      int index);
}
