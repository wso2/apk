...
public final class ApiProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ery.api.GraphqlComplexity\022\021\n\tsystemAPI\030\031" +
      " \001(\010Br\n%org.wso2.choreo.connect.discover" +
      "y.apiB\010ApiProtoP\001Z=github.com/envoyproxy" +
    ...
    internal_static_wso2_discovery_api_Api_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_wso2_discovery_api_Api_descriptor,
        new java.lang.String[] { "Id", "Title", "Version", "ApiType", "Description", "ProductionEndpoints", "SandboxEndpoints", "Resources", "BasePath", "Tier", "ApiLifeCycleState", "SecurityScheme", "Security", "EndpointSecurity", "AuthorizationHeader", "DisableSecurity", "Vhost", "OrganizationId", "IsMockedApi", "ClientCertificates", "MutualSSL", "ApplicationSecurity", "GraphQLSchema", "GraphqlComplexityInfo", "SystemAPI", });
    org.wso2.choreo.connect.discovery.api.EndpointClusterProto.getDescriptor();
    org.wso2.choreo.connect.discovery.api.ResourceProto.getDescriptor();
    org.wso2.choreo.connect.discovery.api.EndpointSecurityProto.getDescriptor();
    org.wso2.choreo.connect.discovery.api.SecuritySchemeProto.getDescriptor();
