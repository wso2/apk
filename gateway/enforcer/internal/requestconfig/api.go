...
type API struct {
	...
	JwtConfigurationDto    *dto.JWTConfiguration `json:"jwtConfigurationDto"`    // JWT configuration DTO
	SystemAPI              bool                  `json:"systemAPI"`              // Whether the API is a system API
	APIDefinition          []byte                `json:"apiDefinition"`          // API definition (e.g., Swagger)
