...
func (s *ExternalProcessingServer) Process(srv envoy_service_proc_v3.ExternalProcessor_ProcessServer) error {
	...
	for {
		...
		case *envoy_service_proc_v3.ProcessingRequest_RequestHeaders:
			...
			if s.requestConfigHolder.MatchedResource != nil && !s.requestConfigHolder.MatchedResource.AuthenticationConfig.Disabled && !s.requestConfigHolder.MatchedAPI.DisableAuthentication {
