package org.wso2.apk.discovery.service.health;
...
public final class HealthGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.wso2.apk.discovery.service.health.HealthCheckRequest,
      org.wso2.apk.discovery.service.health.HealthCheckResponse> getCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Check",
      requestType = org.wso2.apk.discovery.service.health.HealthCheckRequest.class,
      responseType = org.wso2.apk.discovery.service.health.HealthCheckResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.wso2.apk.discovery.service.health.HealthCheckRequest,
      org.wso2.apk.discovery.service.health.HealthCheckResponse> getCheckMethod() {
    io.grpc.MethodDescriptor<org.wso2.apk.discovery.service.health.HealthCheckRequest, org.wso2.apk.discovery.service.health.HealthCheckResponse> getCheckMethod;
    if ((getCheckMethod = HealthGrpc.getCheckMethod) == null) {
      synchronized (HealthGrpc.class) {
        if ((getCheckMethod = HealthGrpc.getCheckMethod) == null) {
          HealthGrpc.getCheckMethod = getCheckMethod =
              io.grpc.MethodDescriptor.<org.wso2.apk.discovery.service.health.HealthCheckRequest, org.wso2.apk.discovery.service.health.HealthCheckResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Check"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.wso2.apk.discovery.service.health.HealthCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.wso2.apk.discovery.service.health.HealthCheckResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<org.wso2.apk.discovery.service.health.HealthCheckRequest,
      org.wso2.apk.discovery.service.health.HealthCheckResponse> getWatchMethod;
  ...
  public static io.grpc.MethodDescriptor<org.wso2.apk.discovery.service.health.HealthCheckRequest,
      org.wso2.apk.discovery.service.health.HealthCheckResponse> getWatchMethod() {
    io.grpc.MethodDescriptor<org.wso2.apk.discovery.service.health.HealthCheckRequest, org.wso2.apk.discovery.service.health.HealthCheckResponse> getWatchMethod;
  ...
  public static abstract class HealthImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void check(org.wso2.apk.discovery.service.health.HealthCheckRequest request,
        io.grpc.stub.StreamObserver<org.wso2.apk.discovery.service.health.HealthCheckResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getCheckMethod(), responseObserver);
    }

    /**
     */
    public void watch(org.wso2.apk.discovery.service.health.HealthCheckRequest request,
        io.grpc.stub.StreamObserver<org.wso2.apk.discovery.service.health.HealthCheckResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.wso2.apk.discovery.service.health.HealthCheckRequest,
                org.wso2.apk.discovery.service.health.HealthCheckResponse>(
                  this, METHODID_CHECK)))
          .addMethod(
            getWatchMethod(),
  ...
  public static final class HealthBlockingStub extends io.grpc.stub.AbstractBlockingStub<HealthBlockingStub> {
    ...
    /**
     */
    public org.wso2.apk.discovery.service.health.HealthCheckResponse check(org.wso2.apk.discovery.service.health.HealthCheckRequest request) {
    ...
    /**
     */
    public java.util.Iterator<org.wso2.apk.discovery.service.health.HealthCheckResponse> watch(
        org.wso2.apk.discovery.service.health.HealthCheckRequest request) {
  ...
  public static final class HealthFutureStub extends io.grpc.stub.AbstractFutureStub<HealthFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.wso2.apk.discovery.service.health.HealthCheckResponse> check(
        org.wso2.apk.discovery.service.health.HealthCheckRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK:
          serviceImpl.check((org.wso2.apk.discovery.service.health.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<org.wso2.apk.discovery.service.health.HealthCheckResponse>) responseObserver);
          break;
        case METHODID_WATCH:
          serviceImpl.watch((org.wso2.apk.discovery.service.health.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<org.wso2.apk.discovery.service.health.HealthCheckResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HealthBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.wso2.apk.discovery.service.health.HealthProto.getDescriptor();
    }
