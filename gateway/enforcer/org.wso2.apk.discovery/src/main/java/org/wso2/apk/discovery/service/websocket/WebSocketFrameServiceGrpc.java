package org.wso2.apk.discovery.service.websocket;
...
public final class WebSocketFrameServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.wso2.apk.discovery.service.websocket.WebSocketFrameRequest,
      org.wso2.apk.discovery.service.websocket.WebSocketFrameResponse> getPublishFrameDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PublishFrameData",
      requestType = org.wso2.apk.discovery.service.websocket.WebSocketFrameRequest.class,
      responseType = org.wso2.apk.discovery.service.websocket.WebSocketFrameResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<org.wso2.apk.discovery.service.websocket.WebSocketFrameRequest,
      org.wso2.apk.discovery.service.websocket.WebSocketFrameResponse> getPublishFrameDataMethod() {
    io.grpc.MethodDescriptor<org.wso2.apk.discovery.service.websocket.WebSocketFrameRequest, org.wso2.apk.discovery.service.websocket.WebSocketFrameResponse> getPublishFrameDataMethod;
      ...
      synchronized (WebSocketFrameServiceGrpc.class) {
        if ((getPublishFrameDataMethod = WebSocketFrameServiceGrpc.getPublishFrameDataMethod) == null) {
          WebSocketFrameServiceGrpc.getPublishFrameDataMethod = getPublishFrameDataMethod =
              io.grpc.MethodDescriptor.<org.wso2.apk.discovery.service.websocket.WebSocketFrameRequest, org.wso2.apk.discovery.service.websocket.WebSocketFrameResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PublishFrameData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.wso2.apk.discovery.service.websocket.WebSocketFrameRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.wso2.apk.discovery.service.websocket.WebSocketFrameResponse.getDefaultInstance()))
  ...
  public static abstract class WebSocketFrameServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<org.wso2.apk.discovery.service.websocket.WebSocketFrameRequest> publishFrameData(
        io.grpc.stub.StreamObserver<org.wso2.apk.discovery.service.websocket.WebSocketFrameResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                org.wso2.apk.discovery.service.websocket.WebSocketFrameRequest,
                org.wso2.apk.discovery.service.websocket.WebSocketFrameResponse>(
  ...
  private static abstract class WebSocketFrameServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.wso2.apk.discovery.service.websocket.MgwWebSocketProto.getDescriptor();
    }
