...
public interface ThrottlingOrBuilder extends
   ...
   */
  org.wso2.apk.discovery.config.enforcer.BinaryPublisher getPublisher();
  /**
   * <code>.wso2.discovery.config.enforcer.BinaryPublisher publisher = 7;</code>
   */
  org.wso2.apk.discovery.config.enforcer.BinaryPublisherOrBuilder getPublisherOrBuilder();
}
