...
public interface ThrottleDataOrBuilder extends
   ...
   */
  java.util.List<org.wso2.apk.discovery.throttle.IPCondition> 
      getIpBlockingConditionsList();
  /**
   * <code>repeated .wso2.discovery.throttle.IPCondition ip_blocking_conditions = 3;</code>
   */
  org.wso2.apk.discovery.throttle.IPCondition getIpBlockingConditions(int index);
  /**
   * <code>repeated .wso2.discovery.throttle.IPCondition ip_blocking_conditions = 3;</code>
   */
   ...
   * <code>repeated .wso2.discovery.throttle.IPCondition ip_blocking_conditions = 3;</code>
   */
  java.util.List<? extends org.wso2.apk.discovery.throttle.IPConditionOrBuilder> 
      getIpBlockingConditionsOrBuilderList();
  /**
   * <code>repeated .wso2.discovery.throttle.IPCondition ip_blocking_conditions = 3;</code>
   */
  org.wso2.apk.discovery.throttle.IPConditionOrBuilder getIpBlockingConditionsOrBuilder(
      int index);
}
