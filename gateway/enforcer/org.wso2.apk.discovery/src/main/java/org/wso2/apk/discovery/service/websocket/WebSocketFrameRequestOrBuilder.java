...
public interface WebSocketFrameRequestOrBuilder extends
   ...
   * @return The metadata.
   */
  org.wso2.apk.discovery.service.websocket.Metadata getMetadata();
  /**
   * <pre>
   * Ext_authz metadata
   * </pre>
   ...
   * <code>.envoy.extensions.filters.http.mgw_wasm_websocket.v3.Metadata metadata = 2;</code>
   */
  org.wso2.apk.discovery.service.websocket.MetadataOrBuilder getMetadataOrBuilder();
   ...
   */
  org.wso2.apk.discovery.service.websocket.WebSocketFrameRequest.MessageDirection getDirection();
