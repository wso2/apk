...
func (in *AIProviderSpec) DeepCopyInto(out *AIProviderSpec) {
	*out = *in
	...
	out.RequestModel = in.RequestModel
	out.ResponseModel = in.ResponseModel
...
func (in *ResolvedBackend) DeepCopyInto(out *ResolvedBackend) {
	*out = *in
	...
	if in.Services != nil {
		...
		*out = make([]v1alpha2.Service, len(*in))
		copy(*out, *in)
	}
	...
	if in.CircuitBreaker != nil {
		...
		*out = new(v1alpha2.CircuitBreaker)
		**out = **in
	}
	if in.Timeout != nil {
		in, out := &in.Timeout, &out.Timeout
		*out = new(v1alpha2.Timeout)
		**out = **in
	}
	if in.Retry != nil {
		in, out := &in.Retry, &out.Retry
		*out = new(v1alpha2.RetryConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.HealthCheck != nil {
		in, out := &in.HealthCheck, &out.HealthCheck
		*out = new(v1alpha2.HealthCheck)
		**out = **in
	}
}
