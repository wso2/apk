...
type ResolvedSecurityConfig struct {
	...
	AWSKey ResolvedAWSKeySecurityConfig
}
...
// ResolvedAWSKeySecurityConfig defines resolved AWS key security configuration
type ResolvedAWSKeySecurityConfig struct {
	Service         string
	In    			string
	Region  		string
	AccessKey 	    string
