...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSKeySecurityConfig) DeepCopyInto(out *AWSKeySecurityConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSKeySecurityConfig.
func (in *AWSKeySecurityConfig) DeepCopy() *AWSKeySecurityConfig {
	if in == nil {
		return nil
	}
	out := new(AWSKeySecurityConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ModelBasedRoundRobin) DeepCopyInto(out *ModelBasedRoundRobin) {
	*out = *in
	if in.ProductionModels != nil {
		in, out := &in.ProductionModels, &out.ProductionModels
		*out = make([]ModelWeight, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SandboxModels != nil {
		in, out := &in.SandboxModels, &out.SandboxModels
		*out = make([]ModelWeight, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResolvedAWSKeySecurityConfig) DeepCopyInto(out *ResolvedAWSKeySecurityConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResolvedAWSKeySecurityConfig.
func (in *ResolvedAWSKeySecurityConfig) DeepCopy() *ResolvedAWSKeySecurityConfig {
	if in == nil {
		return nil
	}
	out := new(ResolvedAWSKeySecurityConfig)
	in.DeepCopyInto(out)
	return out
}
