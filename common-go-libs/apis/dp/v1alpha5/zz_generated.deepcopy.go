...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InBuiltPolicy) DeepCopyInto(out *InBuiltPolicy) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InBuiltPolicy.
func (in *InBuiltPolicy) DeepCopy() *InBuiltPolicy {
	if in == nil {
		return nil
	}
	out := new(InBuiltPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PolicySpec) DeepCopyInto(out *PolicySpec) {
	*out = *in
	...
	if in.RequestInBuiltPolicies != nil {
		in, out := &in.RequestInBuiltPolicies, &out.RequestInBuiltPolicies
		*out = make([]InBuiltPolicy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ResponseInBuiltPolicies != nil {
		in, out := &in.ResponseInBuiltPolicies, &out.ResponseInBuiltPolicies
		*out = make([]InBuiltPolicy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
