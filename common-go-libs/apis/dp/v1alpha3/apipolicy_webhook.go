...
//+kubebuilder:webhook:path=/mutate-dp-wso2-com-v1alpha3-apipolicy,mutating=true,failurePolicy=fail,sideEffects=None,groups=dp.wso2.com,resources=apipolicies,verbs=create;update,versions=v1alpha3,name=mapipolicy.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-dp-wso2-com-v1alpha3-apipolicy,mutating=false,failurePolicy=fail,sideEffects=None,groups=dp.wso2.com,resources=apipolicies,verbs=create;update,versions=v1alpha3,name=vapipolicy.kb.io,admissionReviewVersions=v1
