...
const (
	WSO2KubernetesGateway         = "dp.wso2.com"
	WSO2KubernetesGatewayV2Alpha1 = "dp.wso2.com/v2alpha1"
	...
	EnvoyGatewayV1Alpha1       = "gateway.envoyproxy.io/v1alpha1"
	K8sGatewayAPIV1            = "gateway.networking.k8s.io/v1"
	EnvoyGateway               = "gateway.envoyproxy.io"
	K8sGroupNetworking         = "gateway.networking.k8s.io"
	K8sGroupNetworkingv1Alpha3 = "gateway.networking.k8s.io/v1alpha3"
	K8sGroupNetworkingv1Beta1  = "gateway.networking.k8s.io/v1beta1"
)
