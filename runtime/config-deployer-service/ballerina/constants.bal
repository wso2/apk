...
const string CERTIFICATE_VERSION_NUMBER = "wso2kgw/certificate-version";
const string CERTIFICATE_SERIAL_NUMBER = "wso2kgw/certificate-serial-number";
const string CERTIFICATE_ISSUER = "wso2kgw/certificate-issuer";
const string CERTIFICATE_SUBJECT = "wso2kgw/certificate-subject";
const string CERTIFICATE_NOT_BEFORE = "wso2kgw/certificate-not-before";
const string CERTIFICATE_NOT_AFTER = "wso2kgw/certificate-not-after";
const string CERTIFICATE_HOSTS = "wso2kgw/certificate-host";
const string API_UUID_ANNOTATION = "wso2kgw/api-uuid";
