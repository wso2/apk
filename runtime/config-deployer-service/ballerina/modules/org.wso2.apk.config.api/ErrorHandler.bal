...
# Ballerina class mapping for the Java `org.wso2.apk.config.api.ErrorHandler` interface.
@java:Binding {'class: "org.wso2.apk.config.api.ErrorHandler"}
public distinct class ErrorHandler {

    *java:JObject;

    # The `handle` field that stores the reference to the `org.wso2.apk.config.api.ErrorHandler` object.
    public handle jObj;
    ...
    # The function to retrieve the string representation of the Ballerina class mapping the `org.wso2.apk.config.api.ErrorHandler` Java interface.
    #
    # + return - The `string` form of the Java object instance.
    public function toString() returns string {
        return java:toString(self.jObj) ?: "";
    }
    # The function that maps to the `getErrorCode` method of `org.wso2.apk.config.api.ErrorHandler`.
    #
