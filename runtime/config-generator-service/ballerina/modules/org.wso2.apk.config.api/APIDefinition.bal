...
import config_generator_service.org.wso2.apk.config.model as orgwso2apkruntimemodel;
...
public distinct class APIDefinition {
    ...
    *javalang:Object;
    ...
    public function generateAPIDefinition(orgwso2apkruntimemodel:API arg0) returns APIManagementException|string? {
    ...
    # + return - The `string` or the `APIManagementException` value returning from the Java mapping.
    public function generateAPIDefinition2(orgwso2apkruntimemodel:API arg0, string arg1) returns APIManagementException|string? {
    ...
    #
    # + arg0 - The `string` value required to map with the Java method parameter.
    # + return - The `orgwso2apkruntimemodel:API` or the `APIManagementException` value returning from the Java mapping.
    public isolated function getAPIFromDefinition(string arg0) returns orgwso2apkruntimemodel:API|APIManagementException {
        handle|error externalObj = org_wso2_apk_runtime_api_APIDefinition_getAPIFromDefinition(self.jObj, java:fromString(arg0));
        if (externalObj is error) {
            APIManagementException e = error APIManagementException(APIMANAGEMENTEXCEPTION, externalObj, message = externalObj.message());
            return e;
        } else {
            orgwso2apkruntimemodel:API newObj = new (externalObj);
            return newObj;
        }
    }
...
isolated function org_wso2_apk_runtime_api_APIDefinition_getAPIFromDefinition(handle receiver, handle arg0) returns handle|error = @java:Method {
