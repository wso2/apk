...
public distinct class API {
    ...
    *javalang:Object;
    ...
    public function getContext() returns string {
        return java:toString(org_wso2_apk_runtime_model_API_getContext(self.jObj)) ?: "";
    }
    ...
    public isolated function getEndpoint() returns string {
        return java:toString(org_wso2_apk_runtime_model_API_getEndpoint(self.jObj)) ?: "";
    }
    ...
    public isolated function getScopes() returns javautil:Set {
    ...
    #
    # + return - The `string` value returning from the Java mapping.
    public isolated function getSwaggerDefinition() returns string {
    ...
    public function setContext(string arg0) {
        org_wso2_apk_runtime_model_API_setContext(self.jObj, java:fromString(arg0));
    }
    ...
    public isolated function setEndpoint(string arg0) {
        org_wso2_apk_runtime_model_API_setEndpoint(self.jObj, java:fromString(arg0));
    }
    ...
    public isolated function setScopes(javautil:Set arg0) {
    ...
    #
    # + arg0 - The `string` value required to map with the Java method parameter.
    public isolated function setSwaggerDefinition(string arg0) {
    ...
    public isolated function setUriTemplates(URITemplate[] arg0) returns error? {
        org_wso2_apk_runtime_model_API_setUriTemplates(self.jObj, check jarrays:toHandle(arg0, "org.wso2.apk.config.model.URITemplate"));
    }
...
public function newAPI2(string arg0, string arg1, URITemplate[] arg2) returns API|error {
    handle externalObj = org_wso2_apk_runtime_model_API_newAPI2(java:fromString(arg0), java:fromString(arg1), check jarrays:toHandle(arg2, "org.wso2.apk.config.model.URITemplate"));
    API newObj = new (externalObj);
    return newObj;
}
...
function org_wso2_apk_runtime_model_API_getContext(handle receiver) returns handle = @java:Method {
    name: "getContext",
    'class: "org.wso2.apk.config.model.API",
    paramTypes: []
} external;

isolated function org_wso2_apk_runtime_model_API_getEndpoint(handle receiver) returns handle = @java:Method {
    name: "getEndpoint",
    'class: "org.wso2.apk.config.model.API",
    paramTypes: []
} external;
...
isolated function org_wso2_apk_runtime_model_API_getName(handle receiver) returns handle = @java:Method {
    name: "getName",
    'class: "org.wso2.apk.config.model.API",
    paramTypes: []
} external;

isolated function org_wso2_apk_runtime_model_API_getScopes(handle receiver) returns handle = @java:Method {
    name: "getScopes",
    'class: "org.wso2.apk.config.model.API",
    paramTypes: []
} external;

isolated function org_wso2_apk_runtime_model_API_getSwaggerDefinition(handle receiver) returns handle = @java:Method {
    name: "getSwaggerDefinition",
    'class: "org.wso2.apk.config.model.API",
    paramTypes: []
} external;

isolated function org_wso2_apk_runtime_model_API_getType(handle receiver) returns handle = @java:Method {
    name: "getType",
    'class: "org.wso2.apk.config.model.API",
    paramTypes: []
} external;

isolated function org_wso2_apk_runtime_model_API_getUriTemplates(handle receiver) returns handle = @java:Method {
    name: "getUriTemplates",
    'class: "org.wso2.apk.config.model.API",
    paramTypes: []
} external;

isolated function org_wso2_apk_runtime_model_API_getVersion(handle receiver) returns handle = @java:Method {
    name: "getVersion",
    'class: "org.wso2.apk.config.model.API",
    paramTypes: []
} external;
...
function org_wso2_apk_runtime_model_API_setContext(handle receiver, handle arg0) = @java:Method {
    name: "setContext",
    'class: "org.wso2.apk.config.model.API",
    paramTypes: ["java.lang.String"]
} external;

isolated function org_wso2_apk_runtime_model_API_setEndpoint(handle receiver, handle arg0) = @java:Method {
    name: "setEndpoint",
    'class: "org.wso2.apk.config.model.API",
    paramTypes: ["java.lang.String"]
} external;
...
isolated function org_wso2_apk_runtime_model_API_setScopes(handle receiver, handle arg0) = @java:Method {
    name: "setScopes",
    'class: "org.wso2.apk.config.model.API",
    paramTypes: ["java.util.Set"]
} external;

isolated function org_wso2_apk_runtime_model_API_setSwaggerDefinition(handle receiver, handle arg0) = @java:Method {
