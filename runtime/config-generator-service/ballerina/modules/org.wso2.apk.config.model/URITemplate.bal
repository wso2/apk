...
public distinct class URITemplate {
    ...
    *javalang:Object;
    ...
    public isolated function getEndpoint() returns string {
        return java:toString(org_wso2_apk_runtime_model_URITemplate_getEndpoint(self.jObj)) ?: "";
    }
    ...
    # The function that maps to the `getScope` method of `org.wso2.apk.config.model.URITemplate`.
    #
    ...
    public isolated function setEndpoint(string arg0) {
        org_wso2_apk_runtime_model_URITemplate_setEndpoint(self.jObj, java:fromString(arg0));
    }
    ...
    public isolated function setId(int arg0) {
    ...
    # The function that maps to the `setScope` method of `org.wso2.apk.config.model.URITemplate`.
    #
    # + arg0 - The `Scope` value required to map with the Java method parameter.
    public isolated function setScope(Scope arg0) {
...
isolated function org_wso2_apk_runtime_model_URITemplate_getEndpoint(handle receiver) returns handle = @java:Method {
    name: "getEndpoint",
    'class: "org.wso2.apk.config.model.URITemplate",
    paramTypes: []
} external;
...
isolated function org_wso2_apk_runtime_model_URITemplate_setEndpoint(handle receiver, handle arg0) = @java:Method {
    name: "setEndpoint",
    'class: "org.wso2.apk.config.model.URITemplate",
...
isolated function org_wso2_apk_runtime_model_URITemplate_setId(handle receiver, int arg0) = @java:Method {
    name: "setId",
    'class: "org.wso2.apk.config.model.URITemplate",
    paramTypes: ["int"]
} external;
...
isolated function org_wso2_apk_runtime_model_URITemplate_setScope(handle receiver, handle arg0) = @java:Method {
    name: "setScope",
    'class: "org.wso2.apk.config.model.URITemplate",
    paramTypes: ["org.wso2.apk.config.model.Scope"]
} external;
