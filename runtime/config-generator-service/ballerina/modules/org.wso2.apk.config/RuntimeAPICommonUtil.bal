...
import config_generator_service.org.wso2.apk.config.api as orgwso2apkruntimeapi;
...
# + arg0 - The `string` value required to map with the Java method parameter.
# + arg1 - The `string` value required to map with the Java method parameter.
# + return - The `orgwso2apkruntimemodel:API` or the `orgwso2apkruntimeapi:APIManagementException` value returning from the Java mapping.
public function RuntimeAPICommonUtil_getAPIFromDefinition(string arg0, string arg1) returns orgwso2apkruntimemodel:API|orgwso2apkruntimeapi:APIManagementException {
    handle|error externalObj = org_wso2_apk_runtime_RuntimeAPICommonUtil_getAPIFromDefinition(java:fromString(arg0), java:fromString(arg1));
    if (externalObj is error) {
        orgwso2apkruntimeapi:APIManagementException e = error orgwso2apkruntimeapi:APIManagementException(orgwso2apkruntimeapi:APIMANAGEMENTEXCEPTION, externalObj, message = externalObj.message());
        return e;
    } else {
...
function org_wso2_apk_runtime_RuntimeAPICommonUtil_getAPIFromDefinition(handle arg0, handle arg1) returns handle|error = @java:Method {
